...
const CartView = ({ cart, setCart, setView }) => {
  ...
  const handleCheckout = async () => {
    ...
    try {
        ...
        // Prepare Payload
        // Note: For multi-restaurant carts, we might need to group items or create multiple orders. 
        // For MVP, we assume single restaurant or simple grouping.
        // Taking restaurantId from first item as assumption for MVP simplicity
        const restaurantId = validCartItems.length > 0 ? (validCartItems[0].restaurant_id || 1) : 1; 
